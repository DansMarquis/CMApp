...
import 'package:ghostrunner/user_trail_models/pin_pill_info.dart';
...
import 'package:ghostrunner/pages/timer/timer_clock.dart';
import 'package:toast/toast.dart';
import 'package:ghostrunner/global.dart' as global;
import 'package:ghostrunner/pages/add_trail_form/trailForm.dart';
import 'package:intl/intl.dart';
import 'dart:math';
import 'package:ghostrunner/pages/speedometer/speedometer.dart';
...
Future<Widget> _getImage(BuildContext context, String image) async {
  ...
  Future getDistance2Points(initLat, initLong, finalLat, finalLong) async{
    ...
    global.distance = (distanceInMeters/1000).toString().substring(0,5);
