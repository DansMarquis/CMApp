...
Future getDistance2Points(initLat, initLong, finalLat, finalLong) async {
  double distanceInMeters = await Geolocator()
      .distanceBetween(initLat, initLong, finalLat, finalLong);
...
class GhostRunnerPage extends StatefulWidget {
  final SharedPreferences helper;
  final String identity;

  const GhostRunnerPage({Key key, this.helper, this.identity})
      : super(key: key);
  @override
  State<StatefulWidget> createState() => MapPageState();
}

class MapPageState extends State<GhostRunnerPage> {
...
////////////////////////////////////////////////////
  ...
  void initState() {
    ...
    geolocator.getPositionStream().listen((position) {
      ...
      //position.speed
      new Timer.periodic(
          oneSec, (Timer t) => eventObservable.add(position.speed));
    ...
    if (_pageController.page.toInt() != prevPage && _showTrailOnMap) {
      ...
      _markers.add(Marker(
          ...
          infoWindow: InfoWindow(
              title: trails[_pageController.page.toInt()].trailName,
              snippet: 'Finish Line'),
...
//////////////////////////////////////////////////////////////////////////////////////
  void setSourceAndDestinationIcons() async {
    ...
    ghostIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'assets/ghost-pin.png');
  }
                ...
                child: Stack(
                  children: <Widget>[
                    Positioned(
                        ...
                        child: FutureBuilder(
                            future: _getImage(
                                context, (trails[index].trailID).toString()),
      ...
      body: Stack(
        children: <Widget>[
          ...
          Visibility(
              visible: !_showTimer,
              child: Positioned(
                  left: _showTrailOnMap
                      ? 42
                      : (MediaQuery.of(context).size.width) / 2 - 68,
                  ...
                  child: ButtonTheme(
                    ...
                    child: FlatButton.icon(
                      ...
                      icon: Icon(
                          ...
                          color: Colors.white),
                      label: Text(
                          _showTrailOnMap ? 'Hide Trails' : 'Show Trails',
              ...
              child: Positioned(
                  ...
                  child: ButtonTheme(
                    ...
                    child: FlatButton.icon(
                      ...
                      label: Text('Start Trail', style: BodyStyles.white),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.all(Radius.circular(50.0)),
                      ),
                      onPressed: () {
                        Toast.show(
                            trails[_pageController.page.toInt()].trailName +
                                " TRAIL STARTED!",
                            context,
                        ...
                        timer = new Timer.periodic(
                            new Duration(milliseconds: 20), updateTime);
                      },
                    ),
                  ))),
          Visibility(
              ...
              child: Positioned(
                ...
                child: RawMaterialButton(
                  onPressed: () {
                    Toast.show("NEW TRAIL STARTED!", context,
  ...
  saveOrRefreshWatch() {
    setState(() {
      if (dependencies.stopwatch.isRunning) {
        ...
        getDistance2Points(
            global.locationCoordsStart.latitude,
            global.locationCoordsStart.longitude,
            global.locationCoordsFinish.latitude,
            global.locationCoordsFinish.longitude);
        DateTime now = DateTime.now();
        global.date = DateFormat('yyyy-MM-dd – kk:mm').format(now);
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => NewTrailPage()),
  ...
  void showPinsOnMap() {
    ...
    trails.forEach((element) {
      _markers.add(Marker(
          ...
          draggable: false,
          infoWindow: InfoWindow(title: element.trailName, snippet: 'Start'),
